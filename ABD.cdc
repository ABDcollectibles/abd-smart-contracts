...
pub contract ABD: NonFungibleToken {
    ...
    pub resource Set {
        ...
        pub fun addPlay(playID: UInt32) {
            pre {
                ABD.playDatas[playID] != nil: "Cannot add the Play to Set: Play doesn't exist."
    ...
    pub resource Admin {
        ...
        pub fun borrowSet(setID: UInt32): &Set {
            pre {
                ABD.sets[setID] != nil: "Cannot borrow Set: The Set doesn't exist"
            }
    ...
    pub resource interface MomentCollectionPublic {
        ...
        pub fun borrowMoment(id: UInt64): &ABD.NFT? {
